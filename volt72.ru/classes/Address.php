...
class AddressCore extends ObjectModel
{
	...
	protected	$fieldsSize = array('alias' => 32, 'company' => 32, 'lastname' => 32, 'firstname' => 32,
									...
									'other' => 300, 'phone' => 36, 'phone_mobile' => 36, 'job_mobile' => 36, 'dni' => 16);
	protected	$fieldsValidate = array('id_customer' => 'isNullOrUnsignedId', 'id_manufacturer' => 'isNullOrUnsignedId',
										...
										'job_mobile' => 'isCleanHtml', 'phone' => 'isCleanHtml', 'phone_mobile' => 'isCleanHtml', 'firstname' => 'isName', 'address1' => 'isAddress', 'address2' => 'isAddress', 'postcode'=>'isPostCode',
										'city' => 'isCityName', 'other' => 'isMessage',
										'deleted' => 'isBool', 'dni' => 'isDniLite');
	...
	*/
	...
	public function getFields()
	{
		...
		$fields['job_mobile'] = pSQL($this->job_mobile);
		$fields['vat_number'] = pSQL($this->vat_number);
		$fields['dni'] = pSQL($this->dni);
		$fields['deleted'] = (int)($this->deleted);
		$fields['date_add'] = pSQL($this->date_add);
		$fields['date_upd'] = pSQL($this->date_upd);
		//$fields['id_phone_delivery'] = pSQL($this->id_phone_delivery);
		return $fields;
	}
