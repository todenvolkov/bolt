					...
					'{/literal}{if $search_ssl == 1}{$link->getPageLink('search.php', true)}{else}{$link->getPageLink('search.php')}{/if}{literal}', {
						...
						parse: function(data) {
							...
							for (var i = 0; i < data.length; i++)
								mytab[mytab.length] = { data: data[i], value: data[i].pname + '<div style="text-align:right; display: block; float: right;">'+data[i].reference+'</div>' };
