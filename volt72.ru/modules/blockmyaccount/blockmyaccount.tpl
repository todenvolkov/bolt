...
{*
<div class="block" style="padding-top: 0px; background: none;">
	<h4><b>{l s='My account' mod='blockmyaccount'}</b> кабинет</h4>
	<div class="block_content">
		...
		<p class="logout" style="padding-left: 24px;"><a href="{$link->getPageLink('index.php')}?mylogout" title="{l s='Sign out' mod='blockmyaccount'}">{l s='Sign out' mod='blockmyaccount'}</a></p>
	</div>
</div>
*}
<!-- /Block myaccount module -->