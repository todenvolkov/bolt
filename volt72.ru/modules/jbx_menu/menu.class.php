...
class Menu extends ObjectModel
{
	...
	public static function createCssCache()
	{
		...
		$content .= '.sf-menu ul li:hover, .sf-menu ul li.sfHover, .sf-menu ul li a:focus, .sf-menu ul li a:hover, .sf-menu ul li a:active {color:#222221' . Configuration::get('MENU_ITEM_HOVER_COLOR') . ';}'."\n";
