...
{if $status == 'ok'}
	...
	<p style="background: white;">{l s='Your order on' mod='bankwire'} <span class="bold">{$shop_name}</span> {l s='is complete.' mod='bankwire'}
		<br /><br />
		...
		<br /><br />- {l s='with these details' mod='bankwire'} <br /><span class="bold">{if $bankwireDetails}{$bankwireDetails}{else}___________{/if}</span>
