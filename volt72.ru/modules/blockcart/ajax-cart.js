...
overrideButtonsInThePage : function(){
  ...
  $('.ajax_add_to_cart_button').unbind('click').click(function(){
   ...
   ProductQuantity =  $('.cart_quantity_input_' + idProduct).val();
   if ($(this).attr('disabled') != 'disabled')
        ajaxCart.add(idProduct, null, false, this);
		//ajaxCart.add(idProduct, ProductQuantity, false, this);
        $(this).next('.add_ok').fadeIn(300).delay(1500).fadeOut(500);
   return false;
  });
  
  $('.exclusive2').click(function(){
        $('#add_ok').fadeIn(300).delay(1500).fadeOut(500);
		//$('#add_ok').show();
    });
	...
	add : function(idProduct, idCombination, addedFromProductPage, callerElement, quantity, whishlist){
		...
		$.ajax({
			...
			cache: false,
			dataType : "json",
			data: 'add=1&ajax=true&qty=' + ((ProductQuantity && ProductQuantity != null) ? ProductQuantity : '1') + '&id_product=' + idProduct + '&token=' + static_token + ( (parseInt(idCombination) && idCombination != null) ? '&ipa=' + parseInt(idCombination): ''),
