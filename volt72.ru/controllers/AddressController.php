...
class AddressControllerCore extends FrontController
{
	...
	public function preProcess()
	{
		...
		if (Tools::isSubmit('submitAddress'))
		{
			...
			//reset dni and company name
			if($_REQUEST['select_type']==1){
				$address->dni = NULL;
	...
	public function process()
	{
		...
		$_customer = new Customer((int)(self::$cookie->id_customer));
		if (Validate::isLoadedObject($_customer))
		{
				
				//$_POST['phone'] = $_customer->phone;
				//$_POST['phone_mobile'] = $_customer->phone_mobile;
				//$_POST['job_mobile'] = $_customer->job_mobile;
		}
		self::$smarty->assign('customer', $_POST);
