...
*}
<h1 style="width: 100%; font-size: 26px; font-weight: bold; color: gray; font-family: Calibri; clear: both; text-transform: uppenspace; margin-bottom: 8px;">{l s='Shopping cart summary'}</h1>
{capture name=path}{l s='Your shopping cart'}{/capture}
{include file="$tpl_dir./breadcrumb.tpl"}
<p style="display:none" id="emptyCartWarning" class="warning">{l s='Your shopping cart is empty.'} <a href="/"> Продолжить покупки</a></p>
...
{else}
	...
	var ac_resultstxtProducts = "{l s='products'}";
	// ]]>
	</script>
