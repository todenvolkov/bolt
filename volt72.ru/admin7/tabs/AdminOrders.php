...
class AdminOrders extends AdminTab
{
	...
	public function viewDetails()
	{
		...
		echo '<PRE>';
		//var_dump($addressDelivery);
		echo '</PRE>';
		
		//echo $cart->id_phone_delivery;
		...
		<div style="float: left">
			...
			echo '<BR /><b>Уведомить по '; 
			if ($cart->id_phone_delivery == 1) echo 'домашнему</b>';
			if ($cart->id_phone_delivery == 2) echo 'рабочему</b>';
			if ($cart->id_phone_delivery == 3) echo 'мобильному</b>';
